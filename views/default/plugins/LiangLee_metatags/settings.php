...
$liang_lee_Metainfo8 = elgg_echo('llee:metas:8');
$liang_lee_Metainfo9 = elgg_echo('lianglee:copyr:13');
...
$liang_lee_SiteMeta_7 = elgg_view("input/text", array(
"name" => "params[LiangLee_Gverify]", 
"placeholder" => "JxTsbJ30igb1MGWmzLD8jo+UTvyiYRCR1T63Qx74Y6=",
"value" => $vars['entity']->LiangLee_Gverify
));

$liang_lee_SiteMeta_8 = elgg_view("input/text", array(
"name" => "params[LiangLee_webutation]", 
"placeholder" => "webutation6e5c3d899b9b236dd27821a8a6481afa",
...
$settings = <<<__HTML
    ...
    <div>
		...
		<p></p>
		<p><i>$liang_lee_Metainfo7</i><br>$liang_lee_SiteMeta_7</p>
		<p></p>
		<p><i>$liang_lee_Metainfo8</i><br>$liang_lee_SiteMeta_8</p>
		<p><i>$liang_lee_Metainfo9</i>
